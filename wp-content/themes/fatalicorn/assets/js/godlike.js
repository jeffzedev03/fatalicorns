...
function _initPreloader() {
    ...
    $wnd.on('load', fistClosePreloader);
    $preloader.on('click', '.nk-preloader-skip', fistClosePreloader);
...
function _initSearchBlock() {
    ...
    $wnd.on('nk-open-full-navbar nk-open-cart scroll', function () {
        self.closeSearch();
    });
}
